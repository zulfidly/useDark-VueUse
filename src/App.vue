...
const test = () => {
  console.log('test toggle darkmode');
  console.log(isDark.value);
    isDark.value = !isDark.value
    console.log(isDark.value);
    console.log(useToggle(isDark));
}
...
<template>
  <header>
    ...
    <div class="appearance">
        <button id="BTN1" class="vt-switch" type="button" role="switch" aria-label="Toggle dark mode" aria-checked="">
          <span class="vt-switch-check">
            <span class="dark vt-switch-icon">
    ...
    <p class="bg-blue-400 dark:bg-red-400"> isDark : {{ isDark }}</p>
    <img class="logo" @click="test" alt="Vue logo" src="./assets/logo.svg" width="125" height="125" />
